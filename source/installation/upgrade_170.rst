...
storing session data ke a database, you must add a new column named
user_data ke your session table. Here is an example of what this column
might look like for MySQL::

	user_data text NOT NULL

To add this column you will run a query similar ke this::
...
applications that use it will not break, but you are encouraged ke
migrate ke the new version as soon as possible. Please read the user
