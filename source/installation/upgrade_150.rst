###########################
Upgrade dari 1.4.1 ke 1.5.0
###########################

.. note:: The instructions on this page assume you are running version
	1.4.1. If you have not upgraded ke that version please do so first.
...
Open your application/config/config.php file and ADD these new items::
    ...
    |--------------------------------------------------------------------------
    |
    | This item allows you ke set the filename/classname prefix when extending
    ...
    */
    ...
    | can rewrite the tags on-the-fly, enabling you ke utilize that syntax
...
In that same file REMOVE this item::
    ...
    |--------------------------------------------------------------------------
    |
    | If you would like errors or debug messages logged set this variable ke
...
Error logging is now disabled simply by setting the threshold ke zero.
